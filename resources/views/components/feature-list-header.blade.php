<div class="mb-12 text-center">
            <span class="inline-flex items-center gap-2 px-3 py-1 mb-4 text-xs font-medium tracking-wider uppercase rounded-full bg-violet-500/10 text-violet-500 dark:bg-violet-400/10 dark:text-violet-400">
